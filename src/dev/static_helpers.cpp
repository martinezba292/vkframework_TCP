...
VkPipeline dev::StaticHelpers::createPipeline(Context* context, const char* vert_path, const char* frag_path, VkPipelineLayout pipelineLayout)
{
...
VkImageView dev::StaticHelpers::createTextureImageView(Context* context, VkImage image, VkFormat format, VkImageAspectFlags flags)
{
  Resources* res = ResourceManager::Get()->getResources();
...
VkSampler dev::StaticHelpers::createTextureSampler(Context* context)
{
